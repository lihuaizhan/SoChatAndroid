...
//	public static String HOSTIP = "47.104.134.162:8081";
	public static String HOSTIP = "47.104.134.162:8082";
//	public static String HOSTIP = "172.16.21.242:8080";
	...
	public abstract interface BaseModelIB {
		...
		public abstract void failed(String resultsModel);// 失败 及标识
	}
	...
	public void BIBFailed(BaseModelIB bib, String resultsModel) {

...
import com.hyphenate.easeui.widget.chatrow.EaseChatRowFleetText;
import com.hyphenate.easeui.widget.chatrow.EaseChatRowFleetVoice;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public EaseMessageAdapter(Context context, String username, int chatType, ListView listView, boolean infleet) {
        this.context = context;
        this.listView = listView;
        toChatUsername = username;
        this.conversation = EMClient.getInstance().chatManager().getConversation(username, EaseCommonUtils.getConversationType(chatType), true);
...
//            conversation.markMessageAsRead(toChatUsername);
//            notifyDataSetChanged();
    ...
    EaseChatRow getRowForMessage(EMMessage message, int position) {
    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        if (message.ext() != null) {
            Map<String, Object> ex = message.ext();
//            if (ex.containsKey(EaseUserUtils.ISGIFT)) {
//                if (((Integer) 1).equals(ex.get(EaseUserUtils.ISGIFT)))
//                    return new EaseChatRowGift(context, message, position, this);
//                else
//                    return getRowForMessage(message, position);
//            } else {
//
//                return getRowForMessage(message, position);
//            }

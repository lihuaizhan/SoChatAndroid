...
public class EaseChatRowFleetVoice extends EaseChatRowFile{

    private ImageView voiceImageView;
    private TextView voiceLengthView;
    private ImageView readStatusView;

    public EaseChatRowFleetVoice(Context context, EMMessage message, int position, BaseAdapter adapter) {
    ...
    protected void onInflateView() {
        inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ?
                R.layout.ease_row_received_fleet_voice : R.layout.ease_row_sent_fleet_voice, this);
    }

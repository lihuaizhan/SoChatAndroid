        ...
        if (bitmap != null) {
            ...
            new AsyncTask<Object, Void, Bitmap>() {
                ...
                protected Bitmap doInBackground(Object... args) {
                    ...
                    if (file.exists()) {
                        return EaseImageUtils.decodeScaleImage(thumbernailPath, 360, 360);
                    } else if (new File(imgBody.thumbnailLocalPath()).exists()) {
                        return EaseImageUtils.decodeScaleImage(imgBody.thumbnailLocalPath(), 360, 360);
                    }
                    else {
                        if (message.direct() == EMMessage.Direct.SEND) {
                            if (localFullSizePath != null && new File(localFullSizePath).exists()) {
                                return EaseImageUtils.decodeScaleImage(localFullSizePath, 360, 360);
                            } else {
                                return null;
                            }
                        } else {

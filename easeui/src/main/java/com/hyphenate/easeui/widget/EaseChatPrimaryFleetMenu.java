 ...
 * primary menu
 */
public class EaseChatPrimaryFleetMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    public EaseChatPrimaryFleetMenu(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public EaseChatPrimaryFleetMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EaseChatPrimaryFleetMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.ease_widget_chat_primary_fleet_menu, this);

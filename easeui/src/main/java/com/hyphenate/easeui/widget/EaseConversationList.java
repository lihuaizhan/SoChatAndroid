...
public class EaseConversationList extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        primaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListPrimaryTextColor, Color.parseColor("#333232"));
        secondaryColor = ta.getColor(R.styleable.EaseConversationList_cvsListSecondaryTextColor, Color.parseColor("#333232"));
        timeColor = ta.getColor(R.styleable.EaseConversationList_cvsListTimeTextColor, Color.parseColor("#333232"));
    ...
    public void remarks(boolean remarks){

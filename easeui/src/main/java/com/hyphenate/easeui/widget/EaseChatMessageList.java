...
public class EaseChatMessageList extends RelativeLayout {
     ...
     * @param customChatRowProvider
     */
    public void init(String toChatUsername, String fromavatar,
                     String sendavatar,
                     String fromnick,
                     String sendnick,
                     int chatType, EaseCustomChatRowProvider customChatRowProvider) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true);
        messageAdapter = new EaseMessageAdapter(context, toChatUsername, chatType, listView);
     ...
     * @param customChatRowProvider
     */
    public void initWithFleet(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider, boolean infleet) {
        this.chatType = chatType;
        this.toChatUsername = toChatUsername;
        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername, EaseCommonUtils.getConversationType(chatType), true);
        messageAdapter = new EaseMessageAdapter(context, toChatUsername, chatType, listView, infleet);
        messageAdapter.setShowAvatar(true);
        messageAdapter.setShowUserNick(true);
        messageAdapter.setMyBubbleBg(myBubbleBg);
        messageAdapter.setOtherBuddleBg(otherBuddleBg);

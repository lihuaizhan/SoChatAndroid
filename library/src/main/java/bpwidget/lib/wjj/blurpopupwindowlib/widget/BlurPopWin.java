    ...
    * */
    ...
    private BlurPopWin initBlurPopWin(final Builder builder) {
        if (builder != null) {
            ...
            affirm = rootView.findViewById(R.id.affirm);
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (builder.popupCallback != null) {
                    builder.popupCallback.onCancelClick(BlurPopWin.this);
                }
            }
        });
        affirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (builder.popupCallback != null) {
                    builder.popupCallback.onAffirmClick(BlurPopWin.this);
                }
            }
        });
        return this;
    ...
    public interface PopupCallback {
        ...
        void onCancelClick(@NonNull BlurPopWin blurPopWin);
        void onAffirmClick(@NonNull BlurPopWin blurPopWin);
    }
}

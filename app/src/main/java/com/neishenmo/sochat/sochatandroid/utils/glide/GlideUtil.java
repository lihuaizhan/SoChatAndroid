package com.neishenmo.sochat.sochatandroid.utils.glide;
...
public class GlideUtil {
     ...
     * @param imgUrl    图片地址
     */
    public void loadImage(Activity activity, ImageView imageView,
                          String imgUrl) {
        Glide.with(activity)
                .load(imgUrl)
...
//				.error(R.mipmap.error)
    ...
    public void loadGifImage(Context context, ImageView imageView, String imgUrl) {
        Glide.with(context)
                ...
                .priority(Priority.NORMAL) //下载的优先级
                .diskCacheStrategy(DiskCacheStrategy.ALL) //缓存策略
                .error(R.drawable.pull_list_view_progressbar_bg)
                .into(imageView);
    }

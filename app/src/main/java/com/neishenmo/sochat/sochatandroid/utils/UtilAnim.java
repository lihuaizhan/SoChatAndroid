...
public class UtilAnim {
     ...
     * @param duration
     */
    public static void showUp(final View view, final int duration){
        // 背景渐变动画
        final ObjectAnimator anim = ObjectAnimator.ofFloat(view, "Alpha", 0, 1)
                .setDuration(duration);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
...
//            view_back.setVisibility(View.VISIBLE);
    ...
    private static void hideDowm(final View view, int duration) {
        // 背景渐变动画
